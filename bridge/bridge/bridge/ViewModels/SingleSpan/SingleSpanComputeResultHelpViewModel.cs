...
using bridge.Views.SingleSpan;

namespace bridge.ViewModels.SingleSpan
{
    public class SingleSpanComputeResultHelpViewModel : Screen
    {
        ...
        public SingleSpanComputeResultHelpViewModel(IWindowManager windowManager, Screen parentViewModel)
        {
