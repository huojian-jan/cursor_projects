...
{
    public class SingleSpanViewModel : Screen
    {
        ...
        public SingleSpanViewModel(IWindowManager windowManager)
        {
        ...
        public bool CanConfirm
        {
            get
            {
                ...
                return isSpanLengthValid && isBridgeWidthValid;
            }
        }
        ...
        public async void Help()
        {
            ...
            // 创建帮助视图模型
            var helpViewModel = new SingleSpanComputeHelpViewModel(_windowManager, this);
        ...
        public async void Confirm()
        {
            if (CanConfirm)
            {
                ...
                // 创建SingleSpanView2ViewModel
                var singleSpanView2ViewModel = IoC.Get<SingleSpanView2ViewModel>();
                
                // 传递窗口大小和状态
                singleSpanView2ViewModel.SetWindowSize(currentWidth, currentHeight, currentState);

                // 打开新窗口
                await _windowManager.ShowWindowAsync(singleSpanView2ViewModel);
